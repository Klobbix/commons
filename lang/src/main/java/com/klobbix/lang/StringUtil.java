...
public class StringUtil {
	...
	/**
	 * Combine an array of strings separated by a specified separator.
	 * For example, an call of separate([{"one", "two"}], ":") will return one:two.
	 *
	 * @param strings   The array of strings
	 * @param separator The separator to append between each string
	 * @return A single, separated string
	 */
