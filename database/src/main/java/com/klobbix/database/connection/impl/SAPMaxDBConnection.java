...
public class SAPMaxDBConnection extends AbstractConnection {

    public SAPMaxDBConnection(String host, String port, String schema, String user, String password) {
    ...
    protected HikariConfig buildConfig(String host, String port, String schema, String user, String password) {
        return new HikariConfigBuilder()
                .withDataSourceClassName("com.sap.dbtech.jdbc.DriverSapDB")
                .withUsername(user)
